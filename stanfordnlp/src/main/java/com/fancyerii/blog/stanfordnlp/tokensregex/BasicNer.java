...
public class BasicNer {
	...
	public static void main(String[] args) throws Exception{
		...
		// load sentences
		String exampleSentences = IOUtils.toString(BasicNer.class.getResourceAsStream("/basic_ner.txt"),
		...
		String ruleStr=IOUtils.toString(BasicNer.class.getResourceAsStream("/basic_ner.rules"),
				StandardCharsets.UTF_8);
