...
public class BasicRelationExtraction {
	...
	public static void main(String[] args) throws Exception{
		...
		// load sentences
		String exampleSentences = IOUtils.toString(BasicRelationExtraction.class.getResourceAsStream("/basic_relation.txt"),
		...
		String ruleStr=IOUtils.toString(BasicRelationExtraction.class.getResourceAsStream("/basic_relation.rules"),
				StandardCharsets.UTF_8);
